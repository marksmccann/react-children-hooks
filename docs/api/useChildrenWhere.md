...
| `predicate` | `(element: React.ReactElement) => boolean` | A predicate that is called with each direct child element to determine whether it should be included in the result. |
